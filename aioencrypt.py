...
class AESGCMEncrypt(AESGCMEncryptClassic):
    ...
    @staticmethod
    async def encrypt_file(key: bytes, input_file_name: str, output_file_name: str, associated_data: bytes, chunk_size: int=1024) -> None:
    ...
    @staticmethod
    async def decrypt_file(key: bytes, input_file_name: str, output_file_name: str, associated_data: bytes, chunk_size: int=1024) -> None:
        async with aiofiles.open(input_file_name, 'rb') as fin, aiofiles.open(output_file_name, 'wb') as fout:
    ...
    async def fencrypt(self, input_file_name: str, output_file_name: str, chunk_size: int=1024) -> None:
        await self.encrypt_file(self.key, input_file_name, output_file_name, self.associated_data, chunk_size)

    async def fdecrypt(self, input_file_name: str, output_file_name: str, chunk_size: int=1024) -> None:
